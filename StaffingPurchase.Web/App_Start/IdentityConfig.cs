...
namespace StaffingPurchase.Web
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new CustomUserStore(EngineContext.Current.Resolve<IUserService>()));
    ...
    internal class CustomPasswordHasher : IPasswordHasher
    {
        ...
        {
            return CommonHelper.HashString(password, EngineContext.Current.Resolve<IAppSettings>().PasswordHashAlgorithm);
        }
