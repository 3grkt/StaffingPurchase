...
angular.module("ui-notification").run(["$templateCache", function($templateCache) {$templateCache.put("angular-ui-notification.html","<div class=\"ui-notification\"><h3 ng-show=\"title | translate\" ng-bind-html=\"title | translate\"></h3><div class=\"message\" ng-bind-html=\"message | translate\"></div></div>");}]);