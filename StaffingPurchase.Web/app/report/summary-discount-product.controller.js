(function () {
    ...
    angular
        .module('spApp.report')
        .controller('summaryDiscountProductCtrl', ['$uibModal','$translate','reportService','productService', 'userService', 'Page', 'Notification', 'commonService', 'gridService', summaryDiscountProductCtrl]);

    function summaryDiscountProductCtrl($uibModal, $translate, reportService, productService, userService, Page, Notification, commonService, gridService) {
        var self = this;

        Page.setTitle('PageTitle.AdminReport.SummaryDiscountProduct');
        ...
        self.search = function () {
            if (self.selectedBatchDate) {
                ...
                reportService.searchSummaryDiscountProduct(filter, self.paginationOptions)
                    .then(function (data) {
        ...
        self.export = function() {
            if(self.selectedBatchDate){
                ...
                reportService.downloadSummaryDiscountProduct(filter).then(function(data){
