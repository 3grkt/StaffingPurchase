(function () {
    ...
    angular
        .module('spApp.report')
        .controller('orderByIndividualPVCtrl', ['$uibModal','$translate','reportService','productService', 'userService', 'Page', 'Notification', 'commonService', 'gridService', orderByIndividualPVCtrl]);

    function orderByIndividualPVCtrl($uibModal, $translate, reportService, productService, userService, Page, Notification, commonService, gridService) {
        var self = this;

        Page.setTitle('PageTitle.AdminReport.OrderByIndividualPV');
        ...
        self.search = function () {
            if (self.selectedBatchDate) {
                ...
                reportService.searchOrderByIndividualPV(filter, self.paginationOptions)
                    .then(function (data) {
        ...
        self.export = function() {
            if(self.selectedBatchDate){
                ...
                reportService.downloadOrderByIndividualPV(filter).then(function(data){
